...
pool.query(
    "INSERT INTO TeamAmos2021 (ID, NAME, AGE, DEPARTMENT, ROLE, STATUS, CREATEED_DT) VALUES ('1', 'SARAH', '5', 'Accounting', 'PM', 'Activated', '01-01-2020'), ('2', 'TIM', '10', 'Engineering', 'QA', 'Pending', '02-01-2020'), ('3', 'JOE', '17', 'Management', 'PM', 'Activated', '02-01-2020'), ('4', 'TOLU', '25', 'Management', 'Dev', 'Pending', '02-01-2020'), ('5', 'ROB', '5', 'Engineering', 'QA', 'Activated', '03-01-2020'), ('6', 'ADE', '10', 'Management', 'QA', 'Pending', '04-01-2020'), ('7', 'TOM', '17', 'Security', 'QA', 'Activated', '05-01-2020'), ('8','Jide','26','Accounting','Dev','Activated', '06-01-2021')",
    (err, res) => {
      if(err) {
